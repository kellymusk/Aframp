    ...
    return (
        <div className="space-y-8">
            <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-black tracking-tight uppercase tracking-widest text-[12px]">Safety Verification</h3>
            </div>
            ...
            <div className="space-y-5 bg-card border border-border/50 p-8 rounded-[2rem] shadow-2xl transition-all duration-300">
                <div className="flex items-start space-x-4 group">
                    ...
                    />
                    <Label htmlFor="check-bank" className="text-xs font-bold py-1 leading-relaxed cursor-pointer text-muted-foreground group-hover:text-foreground transition-colors uppercase tracking-wide opacity-80 group-hover:opacity-100">
                ...
                <div className="flex items-start space-x-4 group">
                    <Checkbox
                        ...
                        className="mt-1 h-5 w-5 rounded-lg border-border/50 data-[state=checked]:bg-primary data-[state=checked]:border-primary transition-all duration-300"
                    />
                    <Label htmlFor="check-fees" className="text-xs font-bold py-1 leading-relaxed cursor-pointer text-muted-foreground group-hover:text-foreground transition-colors uppercase tracking-wide opacity-80 group-hover:opacity-100">
                ...
                <div className="flex items-start space-x-4 group">
                    <Checkbox
                        ...
                        className="mt-1 h-5 w-5 rounded-lg border-border/50 data-[state=checked]:bg-primary data-[state=checked]:border-primary transition-all duration-300"
                    />
                    <Label htmlFor="check-address" className="text-xs font-bold py-1 leading-relaxed cursor-pointer text-muted-foreground group-hover:text-foreground transition-colors uppercase tracking-wide opacity-80 group-hover:opacity-100">
                ...
                <div className="pt-4 border-t border-border/30">
                    <div className="flex items-start space-x-4 group">
                        ...
                        />
                        <Label htmlFor="check-memo" className="text-xs font-black py-1 leading-relaxed cursor-pointer text-destructive/70 group-hover:text-destructive transition-colors uppercase tracking-widest underline decoration-destructive/30 underline-offset-4">
