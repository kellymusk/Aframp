    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-black tracking-tight uppercase tracking-widest text-[12px]">Settlement Details</h3>
            </div>
            ...
            <div className="bg-card border border-border/50 rounded-[2rem] p-8 flex flex-col gap-10 items-center relative overflow-hidden shadow-2xl">
                ...
                <div className="space-y-2 text-center">
                    <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em]">Send your {amount} {asset} to:</p>
                </div>
                ...
                <div className="flex-1 space-y-10 w-full">
                    <div className="space-y-4">
                        <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] ml-1">Deposit Address</p>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between px-1">
                            <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em]">Memo: {memo} (REQUIRED)</p>
                        </div>
                        <div className="flex gap-3 items-center">
                        ...
                        <div className="flex items-start gap-4 p-5 bg-destructive/[0.03] rounded-2xl border border-destructive/10">
                            ...
                            <p className="text-xs text-destructive/90 font-bold leading-relaxed opacity-80">
                                You MUST include this memo in your Stellar transaction or your funds will not be credited automatically.
                            </p>
                        </div>
                    </div>
                </div>
